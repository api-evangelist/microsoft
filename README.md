# Microsoft (microsoft)
Collection of Microsoft's primary APIs and developer resources spanning Microsoft 365, Azure, AI, productivity, business applications, identity, and developer tooling.
...
- Azure AD, Office 365, OneDrive, Outlook, Teams
...
- [OpenAPI](openapi/microsoft-graph-openapi.yml)
- [JSONSchema](json-schema/microsoft-graph-user-schema.json)
- [JSONSchema](json-schema/microsoft-graph-group-schema.json)
...
- [OpenAPI](openapi/microsoft-azure-rest-openapi.yml)
- [JSONSchema](json-schema/microsoft-azure-resource-group-schema.json)
...
- AI, GPT, Machine Learning, OpenAI
...
- [OpenAPI](openapi/microsoft-azure-openai-openapi.yml)
...
- AI, Computer Vision, Language, Machine Learning, Speech
...
- [SDKs](https://learn.microsoft.com/en-us/azure/ai-services/cognitive-services-apis-create-account-client-library)
- [OpenAPI](openapi/microsoft-azure-cognitive-services-openapi.yml)
...
- Chat, Collaboration, Messaging, Teams
...
- [SDKs](https://learn.microsoft.com/en-us/microsoftteams/platform/get-started/get-started-overview)
- [OpenAPI](openapi/microsoft-teams-openapi.yml)
- [JSONSchema](json-schema/microsoft-teams-team-schema.json)
...
- Files, OneDrive, SharePoint, Storage
...
- [OpenAPI](openapi/microsoft-onedrive-openapi.yml)
- [JSONSchema](json-schema/microsoft-drive-item-schema.json)
...
- Automation, Business Intelligence, Low Code, Power Apps
...
- [Power Automate API](https://learn.microsoft.com/en-us/power-automate/web-api)
- [OpenAPI](openapi/microsoft-power-platform-openapi.yml)
...
- Bing, Image Search, Search, Web Search
...
- [OpenAPI](openapi/microsoft-bing-search-openapi.yml)
...
- Collaboration, Content Management, Documents, SharePoint
...
- [OpenAPI](openapi/microsoft-sharepoint-openapi.yml)
...
- Analytics, Business Intelligence, Dashboards, Reports
...
- [SDKs](https://learn.microsoft.com/en-us/power-bi/developer/embedded/)
- [Authentication](https://learn.microsoft.com/en-us/power-bi/developer/embedded/register-app)
- [OpenAPI](openapi/microsoft-power-bi-openapi.yml)
...
- CI/CD, DevOps, Git, Pipelines, Work Items
...
- [OpenAPI](openapi/microsoft-azure-devops-openapi.yml)
...
- [OpenAPI](openapi/microsoft-dynamics-365-openapi.yml)
...
- Marketing, Professional Network, Recruiting, Social
...
- [SDKs](https://learn.microsoft.com/en-us/linkedin/shared/development-resources/api-clients)
- [OpenAPI](openapi/microsoft-linkedin-openapi.yml)
...
- [SDKs](https://learn.microsoft.com/en-us/azure/communication-services/concepts/sdk-options)
- [Pricing](https://azure.microsoft.com/en-us/products/communication-services/#pricing)
- [GitHub](https://github.com/Azure/Communication)
- [OpenAPI](openapi/microsoft-azure-communication-services-openapi.yml)
...
- Authentication, Authorization, Directory, Identity, Security
...
- [OpenAPI](openapi/microsoft-entra-id-openapi.yml)
...
- [Mail API Reference](https://learn.microsoft.com/en-us/graph/outlook-mail-concept-overview)
- [Calendar API Reference](https://learn.microsoft.com/en-us/graph/outlook-calendar-concept-overview)
- [Getting Started](https://learn.microsoft.com/en-us/outlook/rest/get-started)
- [OpenAPI](openapi/microsoft-outlook-openapi.yml)
...
- Compliance, Device Management, Endpoint Management, Mobile
...
- [SDKs](https://learn.microsoft.com/en-us/intune/intune-service/developer/app-sdk-get-started)
- [OpenAPI](openapi/microsoft-intune-openapi.yml)
- [JSONSchema](json-schema/microsoft-managed-device-schema.json)
...
- [JSON-LD](json-ld/microsoft-context.jsonld)
- [JSON-LD](json-ld/microsoft-graph-context.jsonld)
